...
const UserGundams = () => {
  ...
  const gundams = useSelector((state) =>
    state.gundam.gundams?.filter((gundam) => gundam.user_id === +id)
  );
  ...
  const upvote = (e, gundamId) => {
    ...
    dispatch(createGundamUpvote(loggedIn.id, gundamId, { gundam: "test" })).then(
      () => {
        if (!pop) {
          dispatch(getGundams());
        } else {
      ...
      <div className="body">
        <div className="body-container">
          <div className="card-container">
            <div>
              <p className="title-text">{user.username}'s Gundam Models</p>
