        ...
        <div className="profile-bottom">
          <div className="profile-bottom-left">
            ...
            <div className="profile-activity">
              <a
                href="https://instagrand.herokuapp.com/"
                target="_blank"
              ...
              >
                <img
                  ...
                  src="https://i.imgur.com/0SdWDf0.png"
                />
                <div className="activity-card-text about">
                  <p className="activity-title">Instagrand</p>
                ...
                <a
                  ...
                  href="https://github.com/riousenkai/instagrand"
                  target="_blank"
                >
                  <img
                    alt="svgImg"
              ...
              >
                ...
                <div className="activity-card-text about">
                  ...
                  <p className="activity-description">
                    Crytpocurrency themed Robinhood clone.
                    <br />
          ...
          <div className="profile-bottom-right">
            <div className="profile-comments-about">
              <img
                className="image"
